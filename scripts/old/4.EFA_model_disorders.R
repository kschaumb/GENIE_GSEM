...
ggsave("gsem/gsem_output/disorder_efa/Scree_plot_eigenvalues_disorders.png",
...
ggsave("gsem/gsem_output/disorder_efa/Parallel_analysis_plot.png",
...
write.csv(fit_tab_full,
          "gsem/gsem_output/disorder_efa/efa_fit_psych_simplified.csv",
          row.names = FALSE)
...
write.csv(L1, "gsem/gsem_output/disorder_efa/efa_loadings_1fac_dx.csv")
write.csv(L2, "gsem/gsem_output/disorder_efa/efa_loadings_2fac_dx.csv")
write.csv(L3, "gsem/gsem_output/disorder_efa/efa_loadings_3fac_dx.csv")
write.csv(L4, "gsem/gsem_output/disorder_efa/efa_loadings_4fac_dx.csv")

if (!is.null(f3$Phi)) write.csv(round(f3$Phi, 3), "gsem/gsem_output/disorder_efa/phi_3factor.csv")
if (!is.null(f4$Phi)) write.csv(round(f4$Phi, 3), "gsem/gsem_output/disorder_efa/phi_4factor.csv")

efa_all <- cbind(L1, L2, L3, L4)
write.csv(efa_all, "gsem/gsem_output/disorder_efa/efa_loadings_all_dx.csv")
