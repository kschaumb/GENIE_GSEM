...
# ============================================================
# Prefers: gsem/gsem_output/symptoms_cfa/cfa_DWLS_results.RDS (consolidated)
# Fallback: per-fit CSVs: *_loadings.csv, *_factor_corr.csv
# Writes : gsem/gsem_output/symptoms_cfa/diagrams/<model>_pathDiagram.(svg|png)
...
OUT_DIR         <- file.path(BASE_DIR, "gsem/gsem_output/symptoms_cfa")
...
# Keep exactly one correlation per latent pair (lhs<rhs)
